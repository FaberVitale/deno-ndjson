...
```typescript
import { parseNdjson } from 'https://deno.land/x/ndjson@v1.0.5/mod.ts';
...
```typescript
import { serializeNdJson } from 'https://deno.land/x/ndjson@v1.0.5/mod.ts';
...
```typescript
import { writeNdjson } from 'https://deno.land/x/ndjson@v1.0.5/mod.ts';
